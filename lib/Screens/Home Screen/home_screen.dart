    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          label: Text(
          isDescending ? 'Sort to Descending' : 'Sort to Ascending'
          ,
          style: TextStyle(color: Colors.orange
          ,
          fontSize: 25
          ...
          Expanded(
            child: Container(
              ...
              child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    final Quick_Sort = PriceList
                    ..sort((lower,upper) => isDescending ? 
                    lower.compareTo(upper) : upper.compareTo(lower));
                    final productlst = Quick_Sort[index];
                    return productcard(
                      index,
                      () => Navigator.push(
                        context,
...
return 
  If(PriceList.length <= 1){
    ...
    lower.append[i];
      return print(Quick_Sort(lower) , pivot , Quick_Sort(greater))
        }
      }
    }
  }
